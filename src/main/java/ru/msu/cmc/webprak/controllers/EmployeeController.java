...
public class EmployeeController {
    ...
    public String listEmployees(Model model,
        ...
        model.addAttribute("searchSurname", searchSurname.orElse(""));
        model.addAttribute("searchName", searchName.orElse(""));
        model.addAttribute("searchPatron", searchPatron.orElse(""));
        return "employees";
    }
    ...
    public String showEmployee(@PathVariable Integer employeeId, Model model) {
        ...
        model.addAttribute("history", employeeDAO.instanceById(employeeId));
        return "employeeId";
    }
